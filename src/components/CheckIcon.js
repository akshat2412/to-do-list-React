...
class CheckIcon extends Component{
	handleClick=()=>{
		this.props.completeTask(
			this.props.current_user.login_id,
			this.props.id
		)
	...
	render(){
		return(
			<svg onClick={this.handleClick} fill="currentColor"  className="svg" preserveAspectRatio="xMidYMid meet" height="40" width="40" viewBox="0 0 40 40" style="vertical-align: middle;">
				<Style
				  scopeSelector=".svg"
				  rules={{
				    color: 'grey',
...
var Container = Radium(CheckIcon);
